...
namespace APIVerve
{
    public class AppStoreScraperAPIClient
    {
        private readonly string _apiEndpoint = "https://api.apiverve.com/v1/appstorescraper";
        ...
        public AppStoreScraperAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public AppStoreScraperAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, AppStoreScraperQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(AppStoreScraperQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(AppStoreScraperQueryOptions options)
        {
